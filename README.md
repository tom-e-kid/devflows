...
| `memo` | Save conversation context to session files |
| `loop` | Smart implementation entry point with graceful degradation |
...
| `implementation-loop` | Task-by-task implementation cycle |
