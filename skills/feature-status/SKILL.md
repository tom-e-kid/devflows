...
2. Check if `docs/sessions/<branch>/` exists
...
### Cleanup
<if merged: remind about docs/sessions/<branch>/ deletion>
```

## Integration with feature-continue

When `feature-continue` detects `docs/sessions/<branch>/` exists:
...
- `docs/sessions/feature-fix-login-bug/`
